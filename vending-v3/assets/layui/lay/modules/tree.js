...
layui.define("form", function(e) {
	...
	b.prototype.config = {
		...
		layui.each(r, function(a, r) {
			...
			l && (h.append(o), n.tree(o, r.children)), e.append(h), h.prev("." + s)[0] && h.prev().children(".layui-tree-pack").addClass("layui-tree-showLine"), l || h.parent(".layui-tree-pack").addClass("layui-tree-lineExtend"), n.alias(h, r), t.showCheckbox && (r.checked && n.checkids.push(r.id), n.checkClick(h, r)), t.edit && n.operate(h, r)
		})
	}, b.prototype.alias = function(e, a) {
		var n = this,
			t = n.config,
			r = e.children("." + p),
			l = r.children("." + f),
