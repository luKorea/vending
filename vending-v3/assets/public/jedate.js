        ...
        methodEventBind: function () {
            ...
            jet.extend(that, {
                ...
                clearBtn: function () {
                    ...
                    that.closeDate();
                    opts.clearfun && opts.clearfun.call(that, { elem: that.valCell, val: '', date: '' });
                },
                //现在按钮函数
                nowBtn: function () {
                ...
                sureBtn: function () {
                    ...
                    if (range) {
                        if (that.selectValue.length == 1) {
                            var selectTime = that.selectValue[0];
                            that.selectValue.push(selectTime)
                            var spTime=selectTime.split('-');
                            var newObj={
                                YYYY:Number(spTime[0]),
                                MM:Number(spTime[1]),
                                DD:Number(spTime[2]),
                                hh:00,
                                mm:00,
                            ...
                            newArr.push(newObj);
                            newArr.push(newObj);
                        }else if (that.selectValue.length > 1) {
