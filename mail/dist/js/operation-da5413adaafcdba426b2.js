...
$.ajax({
  ...
  success: function success(res) {
    if (res.code == 200) {
      ...
      Object(_common_common_js__WEBPACK_IMPORTED_MODULE_1__[/* prompt */ "f"])(res.message);
    }
  },
...
soundFlag == 1 ? $('.sound p').html('售货机静音') : $('.sound p').html('售货机开启声音'); // 开门部分
...
$('.aloneContent .confirmBtn').click(function () {
  ...
  Object(_common_common_js__WEBPACK_IMPORTED_MODULE_1__[/* loadAjax1 */ "d"])('/api/user/verifyAlonePwd', 'post', sessionStorage.token, alonePassObj).then(function (res) {
    $('.aloneContent').fadeOut(100).children('.aloneBox').removeClass('top30');
    Object(_common_common_js__WEBPACK_IMPORTED_MODULE_1__[/* loadAjax1 */ "d"])('/api/openTheDoor', 'post', sessionStorage.token, JSON.stringify({
      machine: machineId
    }), 'mask').then(function (res) {})["catch"](function (err) {
      if (err == 'false') {
        Object(_common_common_js__WEBPACK_IMPORTED_MODULE_1__[/* prompt */ "f"])('开门失败');
      } else {
  ...
  if ($(this).attr('indexFlag') == 1) {
    ...
    Object(_common_common_js__WEBPACK_IMPORTED_MODULE_1__[/* loadAjax1 */ "d"])('/api/switchLight', 'post', sessionStorage.token, lamObj, 'mask').then(function (res) {
      ...
      if (err == 'false') {
        ...
        Object(_common_common_js__WEBPACK_IMPORTED_MODULE_1__[/* prompt */ "f"])('操作成功'); // lamFlag=0;
    ...
    Object(_common_common_js__WEBPACK_IMPORTED_MODULE_1__[/* loadAjax1 */ "d"])('/api/switchVolume', 'post', sessionStorage.token, soundObj, 'mask').then(function (res) {
      ...
      if (err == 'false') {
        ...
        Object(_common_common_js__WEBPACK_IMPORTED_MODULE_1__[/* prompt */ "f"])('操作成功'); // soundFlag=soundFlag==1?0:1;
