...
layui.use(['layer','form'], function () {
    ...
    function information() {
        loadingAjax('/user/getUserInfo', 'post', '', sessionStorage.token,'','','',layer).then(res => {
            console.log(res);
    ...
    $('.editPassBtn').click(function(){
        ...
        loadingAjax('//user/updatePsw','post',passData,sessionStorage.token,'mask',element,ele,layer).then(res=>{
